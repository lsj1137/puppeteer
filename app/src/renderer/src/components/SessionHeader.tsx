    ...
    <div className={`relative min-w-0 transition-[margin] duration-150 ${expanded ? 'mb-1.5' : 'mb-0'}`}>
      ...
      >
        <div className="min-h-0 overflow-hidden">
          <div className="flex min-w-0 items-center gap-1 rounded-md border border-surface1 bg-surface0/60 px-1 py-0.5">
          <button
            type="button"
      ...
      <button
        ...
        className="absolute -top-4 left-1/2 z-10 flex h-4 w-12 -translate-x-1/2 items-center justify-center rounded-t-md border border-b-0 border-surface1 bg-surface0 text-overlay1 transition-colors hover:bg-surface1 hover:text-text"
      >
        {expanded
